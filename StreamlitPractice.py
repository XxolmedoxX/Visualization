...
with tab1:
    ...
    # Fix: Replace density_contour with density_heatmap
    fig5 = px.density_heatmap(filtered_df, x="price", y="minimum_nights", title="Density Heatmap: Price vs Minimum Nights", color_continuous_scale="viridis")
